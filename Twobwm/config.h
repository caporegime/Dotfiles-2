...
static const float    resize_keep_aspect_ratio= 1.02;
///---Offsets---///
/*0)offsetx          1)offsety
 ...
 *6)emptycol         */
static const char *colors[] = {"#325064","#2c2c38","#ccbea3","#807359","#cc9933","#111111","#333333"};
/*
...
static const uint8_t borders[] = {1,2,10,1};
/* Windows that won't have a border.*/
#define LOOK_INTO "WM_NAME"
static const char *ignore_names[] = {"bar", "xclock"};
///--Menus and Programs---///
static const char *menucmd[]   = { "/usr/bin/2bwm_dmenu.sh", NULL };
...
static key keys[] = {
    ...
    // Full screen window without borders overiding offests
